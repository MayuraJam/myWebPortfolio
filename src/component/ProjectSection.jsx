...
const ProjectSection = () => {
  return (
    ...
    <Box sx={{ padding: "40px", paddingBottom: "70px" }} id="project">
      <Header text="Project" />
      <Typography
        variant="h5"
        sx={{ color: colorTheme.woodBrown.main, textAlign: "start", my: 2 }}
      >
        Here are some projects I've worked on, showcasing my skills in various technologies and problem domains.
      </Typography>
      <Grid
        container
        spacing={5}
